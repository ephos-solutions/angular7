...
export class ChangePasswordComponent implements OnInit {
    ...
    createForm() {
        this.form = this.fb.group({
            username: [this.emaildata.username, Validators.compose([Validators.required , Validators.email])],
            confirm_password: ['', Validators.compose([Validators.required , Validators.minLength(8)])],
            password: ['', Validators.compose([Validators.required, Validators.minLength(8)])],
            passwordResetCode: ['', Validators.compose([Validators.required])],
        });
    }
    ...
    onSubmit(event: Event): void {
        ...
        if(this.form.controls['passwordResetCode'].status === 'INVALID'){
            this.errMes['passwordResetCode'] = 'Enter valid password reset code received by email';
